...
@Module({
  ...
  providers: [DynamicDataService, QueryBuilderService, DeleteGuardService, ChildrenService, DataStatusService, UserListConfigService, LookupResolverService, DistributedGuard, DistributionService],
